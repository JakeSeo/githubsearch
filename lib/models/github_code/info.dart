...
@JsonSerializable()
class GithubCodeInfo extends SearchResultInfo {
  @JsonKey(name: "name")
  final String name;
  @JsonKey(name: "path")
  final String path;
  ...
  factory GithubCodeInfo.fromJson(Map<String, dynamic> json) =>
      _$GithubCodeInfoFromJson(json);
  Map<String, dynamic> toJson() => _$GithubCodeInfoToJson(this);
}
