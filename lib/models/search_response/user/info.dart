...
class SearchUserResponseInfo extends SearchResponseInfo {
  ...
  factory SearchUserResponseInfo.fromJson(Map<String, dynamic> json) =>
      _$SearchUserResponseInfoFromJson(json);

  @override
  Map<String, dynamic> toJson() => _$SearchUserResponseInfoToJson(this);
}
// {
//   "total_count": 12,
